...
## Syntax
```C#
public OfficeDevPnP.Core.Framework.Provisioning.Model.CustomActions CustomActions { get; }
public OfficeDevPnP.Core.Framework.Provisioning.Model.CustomActions CustomActions { set; }
```
