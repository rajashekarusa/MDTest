ITemplateFormatter# TemplateProviderBase.GetTemplates members
...
## Syntax
```C#
public collections.generic.list`1<officedevpnp.core.framework.provisioning.model.provisioningtemplate> GetTemplates(ITemplateFormatter)
```
### Parameters
#### formatter
