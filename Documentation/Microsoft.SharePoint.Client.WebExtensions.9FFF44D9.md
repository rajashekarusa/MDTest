Web, String# WebExtensions.SiteSearchScopedByTitle members
...
## Syntax
```C#
public static collections.generic.list`1<officedevpnp.core.entities.siteentity> SiteSearchScopedByTitle(Web, String)
```
### Parameters
#### web
