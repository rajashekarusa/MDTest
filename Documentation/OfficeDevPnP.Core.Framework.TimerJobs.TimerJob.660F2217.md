TimerJob# TimerJob.Clone members
...
## Syntax
```C#
public void Clone(TimerJob)
```
### Parameters
#### job
Type: [OfficeDevPnP.Core.Framework.TimerJobs.TimerJob](OfficeDevPnP.Core.Framework.TimerJobs.TimerJob.md) 
#### 
### Return Value
