...
## Syntax
```C#
public static System.Void RemovePermissionLevelFromUser(SecurableObject securableObject, String userLoginName, RoleType permissionLevel, Boolean removeAllPermissionLevels)
```
### Parameters
*securableObject*  
