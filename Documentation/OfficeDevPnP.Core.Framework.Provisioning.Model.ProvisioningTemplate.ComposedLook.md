...
## Syntax
```C#
public OfficeDevPnP.Core.Framework.Provisioning.Model.ComposedLook ComposedLook { get; }
public OfficeDevPnP.Core.Framework.Provisioning.Model.ComposedLook ComposedLook { set; }
```
