...
## Syntax
```C#
public OfficeDevPnP.Core.Framework.Provisioning.Model.Features Features { get; }
public OfficeDevPnP.Core.Framework.Provisioning.Model.Features Features { set; }
```
