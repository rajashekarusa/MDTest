...
## Syntax
```C#
public OfficeDevPnP.Core.Framework.Provisioning.Providers.Xml.V201503.ContentTypeBinding[] ContentTypeBindings { get; }
public OfficeDevPnP.Core.Framework.Provisioning.Providers.Xml.V201503.ContentTypeBinding[] ContentTypeBindings { set; }
```
