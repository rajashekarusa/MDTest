...
## Syntax
```C#
public Microsoft.SharePoint.Client.ClientContext GetSharePointOnlineAuthenticatedContextTenant(String siteUrl, String tenantUser, SecureString tenantUserPassword)
```
### Parameters
*siteUrl*  
