...
## Syntax
```C#
public Microsoft.SharePoint.Client.ClientContext GetNetworkCredentialAuthenticatedContext(String siteUrl, String user, SecureString password, String domain)
```
### Parameters
*siteUrl*  
