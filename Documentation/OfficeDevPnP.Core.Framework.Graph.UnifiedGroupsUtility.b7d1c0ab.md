...
## Syntax
```C#
public static OfficeDevPnP.Core.Entities.UnifiedGroupEntity CreateUnifiedGroup(String displayName, String description, String mailNickname, String accessToken, String[] owners, String[] members, Stream groupLogo, Boolean isPrivate, Int32 retryCount, Int32 delay)
```
### Parameters
*displayName*  
