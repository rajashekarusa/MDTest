ProvisioningTemplate, ITemplateFormatter, ITemplateProviderExtension[]# JsonTemplateProvider.Save members
...
## Syntax
```C#
public void Save(ProvisioningTemplate, ITemplateFormatter, ITemplateProviderExtension[])
```
### Parameters
#### template
