...
## Syntax
```C#
public static System.Void AddPermissionLevelToGroup(SecurableObject securableObject, String groupName, String roleDefinitionName, Boolean removeExistingPermissionLevels)
```
### Parameters
*securableObject*  
