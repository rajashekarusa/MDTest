ProvisioningTemplate, String, ITemplateProviderExtension[]# TemplateProviderBase.SaveAs members
...
## Syntax
```C#
public void SaveAs(ProvisioningTemplate, String, ITemplateProviderExtension[])
```
### Parameters
#### template
