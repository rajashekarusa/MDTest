...
## Syntax
```C#
public OfficeDevPnP.Core.Framework.Provisioning.Model.SiteSecurity Security { get; }
public OfficeDevPnP.Core.Framework.Provisioning.Model.SiteSecurity Security { set; }
```
