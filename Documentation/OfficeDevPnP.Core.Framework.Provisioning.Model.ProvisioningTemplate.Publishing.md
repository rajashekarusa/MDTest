...
## Syntax
```C#
public OfficeDevPnP.Core.Framework.Provisioning.Model.Publishing Publishing { get; }
public OfficeDevPnP.Core.Framework.Provisioning.Model.Publishing Publishing { set; }
```
